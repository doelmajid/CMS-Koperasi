...
class Daftar extends CI_Controller {
    ...
    function __construct() {    // checked by hatma @ 24 okt 2015
        parent::__construct();
        if (!isset($_SESSION)) {
            session_start();
        }
    ...
    function index() {  // checked by hatma @ 24 okt 2015
        $view_stat = array(
    ...
    function daftar_baru() {    // checked by hatma @ 24 okt 2015
        if ($_POST) {
            $nama = $_POST['nama'];
            $nip = $_POST['nip'];
    ...
    function data() {   // checked by hatma @ 24 okt 2015
        if ($this->session->userdata("daftar") != "") {
            ...
            $data = array(
                ...
                'title' => 'Berikutnya, silahkan cetak form ini (klik tombol Print Formulir di bagian bawah), kemudian tanda tangani dan kumpulkan ke kantor KPRI',
    ...
    function print_data($kode = '') {    // checked by hatma @ 24 okt 2015
        if ($kode != '') {
            $id = $kode;
            $data = array(
