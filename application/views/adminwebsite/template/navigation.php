...
<div class="body">            
    <ul class="navigation">
        ...
        <li>
            <a href="<?php echo base_url(); ?>index.php/adminwebsite/newcontent/" class="button">
                <div class="icon">
                    <span class="ico-copy"></span>
                </div>                    
                <div class="name">Tambah Berita</div>
            </a>          
            <!--
            <ul class="sub">
                <li><a href="<?php echo base_url(); ?>index.php/adminwebsite/newcontent">Tulis Baru</a></li>
        ...
        -->
        <li>
            <a href="<?php echo base_url(); ?>index.php/adminwebsite/insertusers" class="button">
                <div class="icon">
                    <span class="ico-user"></span>
                </div>                    
                <div class="name">Update Anggota</div>
            </a>                
        </li> 
        <li>
            <a href="<?php echo base_url(); ?>index.php/adminwebsite/insertsimpanan" class="button">
                <div class="icon">
                    <span class="ico-chart-4"></span>
                </div>                    
                <div class="name">Upd. Simpanan</div>
            </a>                                      
        </li>
        <li>
            <a href="<?php echo base_url(); ?>index.php/adminwebsite/insertpinjaman" class="button">
                <div class="icon">
                    <span class="ico-chart-4"></span>
                </div>                    
                <div class="name">Upd. Pinjaman</div>
            </a>                                      
        </li>
        <!--
        <li>
        ...
        -->
        <li>
            <a href="<?php echo base_url(); ?>index.php/adminwebsite/settingpassword" class="button">
                <div class="icon">
        ...
        <li>
            <a href="<?php echo base_url(); ?>index.php/adminwebsite/destroyingsession" onclick="return confirm('yakin mau keluar ?');" title="logout" class="button">
                <div class="icon">
