...
<!-- start -->
<form action="<?php echo base_url(); ?>index.php/adminwebsite/savecontent" method="post" enctype="multipart/form-data">
    <div class="row-fluid">
        <div class="span6">
            <div class="block">
                <div class="data-fluid">                                
                    <div class="row-form">
                        ...
                        <div class="span9"><input type="text" class="validate[required]" name="judul_post" value="<?php echo $judul_content; ?>" placeholder="judul berita" required/></div>
                    </div>
                    <div class="row-form">
                        <div class="span3">Gambar Header Berita:</div>
                        <div class="span9">
        ...
        ?>
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            <select name="labels[]" multiple="multiple" class="validate[required] select" style="width: 100%;" required>
        <?php
        foreach ($label as $l) {
        ...
        <div class="span12">   
            <div class="block">
                <div class="head orange">
                    <h2>ISI BERITA = </h2>
                    <ul class="buttons">             
                        <li><a href="#" onClick="source('editor_ck');
                                return false;"><div class="icon"><span class="ico-info"></span></div></a></li>
                    </ul>                                                                
                </div>
                <div class="data-fluid">
                    <textarea id="ckeditor" name="isi" ><?php echo $isi; ?></textarea>
                </div>
            </div>
        </div>
    </div>
